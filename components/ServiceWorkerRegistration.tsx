      ...
      const registerSW = async () => {
        try {
          ...
          if (!registration) {
            ...
            console.log(
              "[SW Registration] No existing registration, registering /sw.js"
            );
            try {
              ...
              console.log(
                "[SW Registration] Registration successful, waiting for ready state..."
              );
              ...
              console.log(
                "[SW Registration] Service worker is ready and active"
              );
            } catch (err) {
              console.error(
            ...
            if (registration.waiting) {
              console.log(
                "[SW Registration] Service worker waiting, sending SKIP_WAITING message"
              );
            ...
            if (registration.active) {
              console.log(
                "[SW Registration] Service worker state:",
